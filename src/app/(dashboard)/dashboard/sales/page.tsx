...
export default function SalesPage() {
  ...
  const previewTotal = preview500 + preview1000;
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
          <div className="bg-slate-800 rounded-xl p-6 w-full max-w-md border border-slate-700">
            <h2 className="text-lg font-semibold text-white mb-4">Record Daily Sales</h2>
              ...
              <div className="p-3 rounded-lg bg-slate-700/50 border border-slate-600">
                ...
                <div className="space-y-1 text-xs text-slate-400">
                  ...
                  <div className="flex justify-between border-t border-slate-600 pt-1 font-medium text-sm">
                    ...
                    <span className="text-green-400">{formatCurrency(previewTotal)}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-700 text-slate-400 text-xs uppercase">
                ...
                <th className="px-4 py-3 text-right">Rev 500</th>
            ...
            <tbody>
              {filtered.map((s: any) => (
                <tr key={s.id} className="border-b border-slate-700/50 hover:bg-slate-700/30 transition">
                  ...
                  <td className="px-4 py-3 text-right text-slate-400">{formatCurrency(s.revenue_500)}</td>
